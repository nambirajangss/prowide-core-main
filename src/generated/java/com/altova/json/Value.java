...
// Value.java
//
// This file was generated by MapForce MapForce 2025.
//
...
public abstract class Value extends java.lang.Object implements com.altova.mapforce.IMFNode {
	...
	protected void Validate(Validator validator, ValueAcceptor root) {
		HashMap<Value, ValidationInfo> itemInfos = new HashMap<Value, ValidationInfo>();
		ValidationInfo r = DoValidate(validator, root, itemInfos);
		...
		if (jsonLines) {
			if (this instanceof Array) {
				...
				for (Value item: array.getItems()) {
					item.Validate(validator, schemas[0]);
				}
			}
		} else {
			Validate(validator, schemas[0]);
		}
	}
