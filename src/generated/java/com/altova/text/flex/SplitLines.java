...
public class SplitLines extends Splitter {
	...
	public void prepareUpper(StringBuffer buffer, String lineEnd) {
		if (nLines >= 0) {
			makeBufferNLines(buffer, nLines, lineEnd);
		}			
	}
	
	public void prepareLower(StringBuffer buffer, String lineEnd) {
		if (nLines < 0) {
			makeBufferNLines(buffer, -nLines, lineEnd);
		}
	}

	static void makeBufferNLines(StringBuffer buffer, int n, String lineEnd) {
		int p = 0;
