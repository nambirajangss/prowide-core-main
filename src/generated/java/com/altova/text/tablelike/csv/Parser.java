...
public class Parser extends RecordBasedParser {
	...
	boolean wasLastCharacterFieldDelimiter() {
		if (0 < m_CurrentOffset)
			return m_Format.isFieldDelimiter(m_Buffer.charAt(m_CurrentOffset - 1));
		else
			return false;
	}
	...
	boolean wasLastCharacterQuote() {
		if (0 < m_CurrentOffset)
			return m_Format.isQuoteCharacter(m_Buffer.charAt(m_CurrentOffset - 1));
		else
			return false;
	}
