...
public class XmlTreeOperations {
	...
	public static void saveDocument( Document doc, com.altova.io.Output output, String encoding, boolean bBigEndian, boolean bBOM, boolean prettyPrint, boolean omitXmlDecl, boolean standalone ) throws Exception {
		switch (output.getType()) {
		case com.altova.io.Output.IO_STREAM:
			saveDocument(doc, output.getStream(), encoding, bBigEndian, bBOM, prettyPrint, omitXmlDecl, standalone);
			break;
			
		case com.altova.io.Output.IO_WRITER:
			saveXml(doc, prettyPrint, omitXmlDecl, standalone, output.getWriter());
			break;
	...
	public static void saveDocument( Document doc, java.io.OutputStream targetStream, String encoding, boolean bBigEndian, boolean bBOM, boolean prettyPrint, boolean omitXmlDecl, boolean standalone ) throws Exception {
		if (prettyPrint)
			indentNode(doc.getDocumentElement(), 0);
	
		try (java.io.ByteArrayOutputStream result = new java.io.ByteArrayOutputStream()) {
			internalSave(new javax.xml.transform.stream.StreamResult(result), doc, encoding, omitXmlDecl, standalone);
	...
	public static void saveDocument( Document doc, String filename, String encoding, boolean bBigEndian, boolean bBOM, boolean prettyPrint, boolean omitXmlDecl, boolean standalone ) throws Exception {
		try (java.io.FileOutputStream outStream = new java.io.FileOutputStream( filename, false )) {
			saveDocument(doc, outStream, encoding, bBigEndian, bBOM, prettyPrint, omitXmlDecl, standalone);
		}
	}
	...
	public static byte[] saveXmlBinary( Document doc, String encoding, boolean bBigEndian, boolean bBOM, boolean prettyPrint ) throws Exception {
		...
		try (java.io.ByteArrayOutputStream result = new java.io.ByteArrayOutputStream()) {
			internalSave(new javax.xml.transform.stream.StreamResult(result), doc, encoding, false, false);
	...
	private static void saveXml( Document doc, boolean prettyPrint, boolean omitXmlDecl, boolean standalone, java.io.Writer writer ) throws Exception {
		if (prettyPrint)
			indentNode(doc.getDocumentElement(), 0);

		try {
			internalSave(new javax.xml.transform.stream.StreamResult(writer), doc, null, omitXmlDecl, standalone);
			writer.flush();
		} catch (Exception e) {
			throw new com.altova.TargetInstanceUnavailableException("Cannot serialize.", e);
		}
	...
	public static String saveXml( Document doc, boolean prettyPrint, boolean omitXmlDecl, boolean standalone ) throws Exception {
		java.io.StringWriter result = new java.io.StringWriter();
		saveXml(doc, prettyPrint, omitXmlDecl, standalone, result);
		return result.toString();
	}
	
	protected static void internalSave(javax.xml.transform.Result result, Node node, String encoding, boolean omitXmlDecl, boolean standalone) throws Exception {
		try {
