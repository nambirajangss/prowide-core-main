...
public class Field70__2 {
    ...
    @Expose
    private List<Structured__5> structured;
    ...
    public List<Structured__5> getStructured() {
        return structured;
    }

    public void setStructured(List<Structured__5> structured) {
