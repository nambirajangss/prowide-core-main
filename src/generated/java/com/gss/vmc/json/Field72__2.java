...
public class Field72__2 {
    ...
    @Expose
    private List<Structured__6> structured;
    ...
    public List<Structured__6> getStructured() {
        return structured;
    }

    public void setStructured(List<Structured__6> structured) {
