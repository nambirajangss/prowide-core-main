...
public class Field72__3 {
    ...
    @Expose
    private List<Structured__8> structured;
    ...
    public List<Structured__8> getStructured() {
        return structured;
    }

    public void setStructured(List<Structured__8> structured) {
