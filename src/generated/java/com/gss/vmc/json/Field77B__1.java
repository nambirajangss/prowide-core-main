...
public class Field77B__1 {
    ...
    @Expose
    private List<Structured__7> structured;
    ...
    public List<Structured__7> getStructured() {
        return structured;
    }

    public void setStructured(List<Structured__7> structured) {
