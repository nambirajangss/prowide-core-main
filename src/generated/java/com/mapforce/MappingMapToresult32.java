...
public class MappingMapToresult32 extends com.altova.TraceProvider {
	...
	static class Main implements IEnumerable {
		...
		public static class Enumerator implements IEnumerator {
			...
			com.altova.mapforce.IEnumerable var4_last;
			IEnumerator var5_last;
			java.lang.String var6_if_equal;
			java.lang.String var7_if_logical_and;
			...
			private boolean moveNext_2() throws Exception {
				...
				var3_last = (java.lang.String)com.altova.functions.Core.last((new seq16_join(var2_as_object)));
				var4_last = new com.altova.functions.Core.SequenceCache((new seq18_if_logical_and(var3_last)));
				var5_last = (var4_last).enumerator();
				return false;
			}
			private boolean moveNext_4() throws Exception {
				state = 4;				
				if (!var5_last.moveNext()) {state = 5; return false; }
				var6_if_equal = (java.lang.String)com.altova.functions.Core.first((new seq20_if_equal(((java.lang.String)(var5_last.current())))));
				var7_if_logical_and = (java.lang.String)com.altova.functions.Core.first((new seq21_if_logical_and(var4_last, var6_if_equal)));
				if (!(com.altova.functions.Core.equal(var7_if_logical_and, "NOTPROVIDED"))) {state = 6; return false; }
				current = "NOTPROVIDED";
				pos++;
				return true;
			}
			private boolean moveNext_5() throws Exception {
				state = 0;				
				if( var5_last != null ) { var5_last.close(); var5_last = null; }
				return false;
			}
			private boolean moveNext_6() throws Exception {
				state = 4;				
				current = com.altova.functions.Core.concat(com.altova.functions.Core.concat(var7_if_logical_and, " "), com.altova.functions.Core.concat("//", var7_if_logical_and));
				pos++;
				return true;
			}
	...
	static class seq13_map implements IEnumerable {
		...
		public static class Enumerator implements IEnumerator {
			...
			private boolean moveNext_1() throws Exception {
				state = 2;				
				var2_object_member_by_name = (com.altova.functions.Json.GetMemberByName(closure.var1_cur, "field57B")).enumerator();
				return false;
			}
			private boolean moveNext_2() throws Exception {
				state = 2;				
	...
	static class seq16_join implements IEnumerable {
		...
		public static class Enumerator implements IEnumerator {
			...
			private boolean moveNext_4() throws Exception {
				state = 6;				
				if (!var3_as_object.moveNext()) {state = 5; return false; }
				var4_object_member_by_name = (com.altova.functions.Json.GetMemberByName(((com.altova.json.Value)(var3_as_object.current())), "field57B")).enumerator();
				return false;
			}
			private boolean moveNext_5() throws Exception {
				state = 2;				
	...
	static class seq18_if_logical_and implements IEnumerable {
		java.lang.String var1_cur;

		public seq18_if_logical_and(java.lang.String var1_cur)	{
			this.var1_cur = var1_cur;
		}
		...
		public static class Enumerator implements IEnumerator {
			...
			int state = 1;
			Object current;
			seq18_if_logical_and closure;
			java.lang.String var2_if_logical_and;

			public Enumerator(seq18_if_logical_and closure) {
				this.closure = closure;
			}
			...
			private boolean moveNext_1() throws Exception {
				state = 0;				
				var2_if_logical_and = (java.lang.String)com.altova.functions.Core.first((new seq19_if_logical_and(closure.var1_cur)));
				if (!(CTR18ClearingIdentifier.IsMTClearingSystemCodeInList(var2_if_logical_and))) {state = 2; return false; }
				return false;
			}
			private boolean moveNext_2() throws Exception {
				state = 0;				
				current = var2_if_logical_and;
				pos++;
				return true;
			}
	...
	static class seq19_if_logical_and implements IEnumerable {
		java.lang.String var1_cur;

		public seq19_if_logical_and(java.lang.String var1_cur)	{
			this.var1_cur = var1_cur;
		}
		...
		public static class Enumerator implements IEnumerator {
			...
			int state = 1;
			Object current;
			seq19_if_logical_and closure;

			public Enumerator(seq19_if_logical_and closure) {
				this.closure = closure;
			}
			...
			private boolean moveNext_1() throws Exception {
				state = 0;				
				if (!(com.altova.functions.Core.logicalAnd(com.altova.functions.Core.startsWith(closure.var1_cur, "/"), com.altova.functions.Core.logicalNot(com.altova.functions.Core.startsWith(closure.var1_cur, "/CH"))))) {state = 2; return false; }
				current = closure.var1_cur;
				pos++;
				return true;
			}
			private boolean moveNext_2() throws Exception {
	...
	static class seq20_if_equal implements IEnumerable {
		...
		public seq20_if_equal(java.lang.String var1_cur)	{
			this.var1_cur = var1_cur;
		}
	...
	static class seq21_if_logical_and implements IEnumerable {
		com.altova.mapforce.IEnumerable var1_last;
		java.lang.String var2_cur;

		public seq21_if_logical_and(com.altova.mapforce.IEnumerable var1_last, java.lang.String var2_cur)	{
		...
		public static class Enumerator implements IEnumerator {
			...
			int state = 1;
			Object current;
			seq21_if_logical_and closure;

			public Enumerator(seq21_if_logical_and closure) {
				this.closure = closure;
			}
			...
			private boolean moveNext_1() throws Exception {
				state = 0;				
				if (!(com.altova.functions.Core.logicalAnd(com.altova.functions.Core.exists(closure.var1_last), com.altova.functions.Core.logicalNot(com.altova.functions.Core.startsWith(closure.var2_cur, "RT"))))) {state = 2; return false; }
	...
	public String run(String MasterFieldsV54SourceFilename) throws Exception {
		try(
			...
			// run
		String varresult3TargetParameter =		run(MasterFieldsV54Source);

			return varresult3TargetParameter;
		}
	}
	...
	public String run(com.altova.io.Input MasterFieldsV54Source) throws Exception {
		try {
			...
			String varresult3TargetParameter = com.altova.functions.Core.last(mapping).toString();
