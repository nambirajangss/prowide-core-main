...
public enum MtSequenceEnum {
    ...
    RMT205COV("13C"),
    SMT103RETN("A"),
    RMT103RETN("13C,23E,71F"),
    SMT205RETN("A,B"),
    RMT205RETN("13C"),
    
    RULESCTR15("52A,52D,53A,53B,53D,54A,54D,55A,55D,56A,56C,56D,57A,57D,58A,57C,54B"),
    	//57C added along with CTR15, for the reason of CTR195.
    	//54B added along with CTR15, for the reason of CTR165.
    RULESCTR9("50A,50F,50K,59,59A,59F"),
