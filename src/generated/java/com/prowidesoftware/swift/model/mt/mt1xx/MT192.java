...
import com.prowidesoftware.swift.model.mt.mt2xx.MT200.SequenceA;
...
public class MT192 extends AbstractMT implements Serializable {
	...
	*/
	...
	//############################################################### SEQUENCE STARTS HERE
			...
			/**
			 * Class to model Sequence "A" in MT 103.
			 */
			public static class SequenceA extends SwiftTagListBlock {
				 ...
				 * Array format is for cases when more than one letter options is allowed
				 */
				protected static final String[] END = { "11S"   };

				/**
				 * List of optional tags after the last mandatory tag.
				 */
				protected static final String[] TAIL = new String[]{ "79" };
