...
public class Tag implements Serializable {
    ...
    public Tag(String inner) {
        ...
        if (i >= 0) {
        	...
        	//TODO Here for : issues
        	Objects.requireNonNull(this.name, "Validation Error: Found unrecognized Tag/Field {"+inner+"} in the message or a malformed message block structure");
